...
public class SoundManager {
    ...
    public void loadSoundEffects(String id, String url) {
        AudioClip sound = new AudioClip(getClass().getResource(url).toString());
        soundEffectsMap.put(id, sound);
    }
     ...
     */
    public void playSound(final String id,boolean isSoundOn) {
        if(isSoundOn){
    ...
    public void stopSound(final String id,boolean isSoundOn) {
        if(isSoundOn)
